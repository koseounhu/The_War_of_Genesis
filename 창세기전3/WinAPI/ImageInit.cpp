...
void MainGame::ImageInit(void)
{
	...
	IMAGEMANAGER->addFrameImage("스킬불기둥1", PL"불기둥1.bmp", 1600, 300, 32, 1, true, SKILL);
	IMAGEMANAGER->addFrameImage("스킬불기둥1_1", PL"불기둥1_1.bmp", 1600, 300, 32, 1, true, SKILL);
	IMAGEMANAGER->addFrameImage("스킬불기둥2", PL"불기둥2.bmp", 1600, 300, 32, 1, true, SKILL);
